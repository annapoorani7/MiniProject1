          ...
          <div className="card mb-3 emp-card shadow-sm border-0" key={index}>
            <div className="card-body d-flex align-items-center">
              ...
              <div className="flex-grow-1">
                <p className="mb-1"><strong>Registration/ID:</strong> {emp.id}</p>
                <p className="mb-1"><strong>Employee Role:</strong> {emp.role}</p>
              ...
              {/* Button */}
              <div>
                <button className="btn btn-danger print-btn">
                  Print Job Letter
                </button>
              </div>
            </div>
